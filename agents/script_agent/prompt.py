...
def _active_script_constraints(policy: ScriptLengthPolicy) -> str:
    ...
    return (
        ...
        "stored in calculation_verifications with verified=true. A deterministic-calculation "
        "claim binding must set calculation_verification_id to the matching verification_id; its "
        "reference may be null because pure arithmetic does not require an external citation. "
